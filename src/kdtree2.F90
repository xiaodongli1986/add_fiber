...
!      print*,'within build tree calling build tree for range',tp%n
      tp%root => build_tree_for_range(tp,1,tp%n, dummy)
!      print*,'within build tree back from build tree for range'
...
!      print*,'within build tree for range at  1',(u-l),tp%n,bucket_size
...
!      print*,'within build tree for range at  2',(u-l),tp%n,bucket_size
...
!        print*,'within build tree for range at  3',m,l,u
